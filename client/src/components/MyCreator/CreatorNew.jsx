...
export const CreatorNew = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const [creatorResponse, analyticsResponse, stocksResponse] =
          await Promise.all([
                ...
                <li className="nav-item dropdown no-arrow">
                  ...
                  >
                    <span className="mr-2 d-none d-lg-inline text-gray-600 small">
                      {creatorData ? creatorData.name : "Creator Name"}
                    </span>
                    <img
                  ...
                  <div className="card shadow mb-4">
                    ...
                    <div className="card-body">
                      <ul>
                        ...
                        <li>
                          Subscribers: {analyticsData.stats[0].subscribers}
                        </li>
                        <li>VideoCount: {analyticsData.stats[0].videoCount}</li>
                        <li>
                          Current Valuation: {analyticsData.stats[0].valuation}
                        </li>
                      </ul>
